...
extern volatile MOTIONGEAR_t, MOTIONGEAR;
...
extern volatile double destination;
...
void sensorInterrupts(){
    ...
    if (INT0 == 1){
        ...
        RC2 = 0; merge with navigationinterrupt.c
        turnOnBrake();
    }
...
# 1 "./ptGPS.h" 1
# 16 "./ptGPS.h"
extern double gpsInput;
_Bool destinationArrived();
# 13 "./drivingFx.c" 2
static _Bool destinationArrived;

void drivingFx(void) {


    if(gpsInput == destination){
        destinationArrived = 1;
    }


}
# 25 "navigationInterrupt.c" 2
# 1 "./core/sensorsFx.c" 1

# 1 "./core/../ptGPS.h" 1
# 3 "./core/sensorsFx.c" 2
...
# 26 "navigationInterrupt.c" 2
# 35 "navigationInterrupt.c"
void __attribute__((picinterrupt(("high_priority")))) high_isr(void)
# 44 "navigationInterrupt.c"
{
# 56 "navigationInterrupt.c"
      if(INT0IF == 1)
      {
          Front_Obstacle_Int(0);
